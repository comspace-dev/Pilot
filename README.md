...
Pass your desired <code>font-size</code> and a multiple of the <code>$base-spacing-px</code> and the <code>line-height</code> will be calculated accordingly. You can pass "normal" for the line-height as well.
